...
class ColorRotationPattern final : public LEDPattern {
public:
    const char* name() const override { return "COLOR_ROTATION"; }
...
private:
    ...
    RGB hsv_to_rgb(float hue, float saturation, float value) const;
};
