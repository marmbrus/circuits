...
LEDConfig::Pattern LEDConfig::parse_pattern(const char* value) {
    ...
    if (strcmp(value, "METEOR_SHOWER") == 0) return Pattern::METEOR_SHOWER;
    if (strcmp(value, "JUNGLE_CANOPY") == 0) return Pattern::JUNGLE_CANOPY;
    if (strcmp(value, "UNDERSEA_GROTTO") == 0) return Pattern::UNDERSEA_GROTTO;
    if (strcmp(value, "COLOR_ROTATION") == 0) return Pattern::COLOR_ROTATION;
...
const char* LEDConfig::pattern_to_string(LEDConfig::Pattern p) {
    switch (p) {
        ...
        case Pattern::METEOR_SHOWER: return "METEOR_SHOWER";
        case Pattern::JUNGLE_CANOPY: return "JUNGLE_CANOPY";
        case Pattern::UNDERSEA_GROTTO: return "UNDERSEA_GROTTO";
        case Pattern::COLOR_ROTATION: return "COLOR_ROTATION";
    }
    return "OFF";
}
